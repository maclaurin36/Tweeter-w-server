...
public class FollowAction extends BaseFollowAction{

    public FollowAction(FollowDao followDao, UserDao userDao, AuthDao authDao, FollowUnfollowRequest request) {
    ...
    protected void performFollowUnfollow(String userToBeUnfollowedFollowed, String originalUser) {
        followDao.insertFollower(userToBeUnfollowedFollowed, originalUser);
    }
